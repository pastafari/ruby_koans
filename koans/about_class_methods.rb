...
class AboutClassMethods < EdgeCase::Koan
  ...
  def test_objects_have_methods
    fido = Dog.new
    assert fido.methods.size > 10 # Object comes with 95 methods of which 56 are instance methods, 
                                  # so fido.methods.size == 56
  end

  def test_classes_have_methods
    assert Dog.methods.size > 30 
  end
  ...
  # First one is more readable, Second one allows a bunch of methods to be defined as class methods together.
  # ------------------------------------------------------------------
