...
class AboutMessagePassing < EdgeCase::Koan
  ...
  def test_send_with_underscores_will_also_send_messages
    ...
    # A: --- because send could be overridden by some class/object and then we're screwed.
    #    --- by convention, __send__ should not be overridden, and Ruby generates a warning if it is.
  end
  ...
  def test_calling_method_missing_causes_the_no_method_error
    ...
    # A --- we can handle bad method names. for instance, we can dynamically define methods that
    # aren't already defined and get them to do something. OR we can log the call and still raise the error
    # method_missing is a callback that happens automatically if Ruby encounters a badly named method
    # SEE ALSO: Delegator class builtin to Ruby
